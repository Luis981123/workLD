      ...
      if (
          ...
          Swal.fire({
            ...
            timer: 2000
              ...
              if (result.dismiss) {
                this.props.navigate('/inactivejob');
              }
        })
      }
  }
            ...
            <div className='p-6 mt-2 border-2 border-gray-200 rounded-xl'>
              {/* <form> */}
                ...
                <div className='mb-6 md:w-1/2 pr-2'>
                  ...
                  <div className='relative'>
                    <select
                      ...
                      id='tariff'
                    >
                      <option>Базовый (1000р.)</option>
                      <option>Базовый + результат (5000р.)</option>
                      <option>Базовый + результат + гарантия (10000р.)</option>
                    </select>
                    <div className='pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700'>
                      <svg
                        className='fill-current h-4 w-4'
                ...
                <div className='flex flex-col middle:flex-row gap-6 justify-center middle:justify-start items-center mt-10'>
                  <button onClick={this.handleSave} className='bg-button text-white font-bold py-2 px-4 rounded w-full middle:w-fit'>
